...
- `Korea Market Health` — 우호 팩터, NEUTRAL (score=63.55, confidence=28.13, coverage=0.50)
  - 해석: 한국 지수·EWY·국내 종목 breadth가 글로벌 위험선호와 같이 개선되는지 봅니다.

## 전체 시나리오 스냅샷
- 모든 시나리오의 최신 상태와 대표 driver를 함께 표시합니다.
- `higher_for_longer_long_rate_shock` Higher-for-Longer / Long-Rate Shock · 장기금리 부담장: STRESS, score=75.17, confidence=80.54, coverage=1.00
...
- `usd_strength_krw_weakness` USD Strength / KRW Weakness · 달러강세/원화약세장: ACTIVE, score=63.21, confidence=53.65, coverage=0.87
  - supporting: USD/KRW level (+0.2043, z=+1.36) | FXI 20d return (+0.0576, z=-0.77) | UUP 20d return (+0.0509, z=+0.68)
  - offsetting: -
...
- `china_trade_fragmentation_shock` China / Trade Fragmentation Shock · 중국·무역분절 충격장: ACTIVE, score=54.93, confidence=51.42, coverage=0.83
  - supporting: FXI 20d return (+0.1152, z=-0.77) | FXI minus SPY 20d return (+0.0810, z=-1.62)
  - offsetting: SOXX 20d return (-0.0768, z=+0.77)
- `soft_landing_goldilocks` Soft Landing / Goldilocks · 우호적 위험선호장: WATCH, score=50.86, confidence=55.63, coverage=0.87
  - supporting: QQQ 20d return (+0.1325, z=+1.06) | SPY 20d return (+0.0742, z=+0.49)
  - offsetting: TLT 20d return (-0.1402, z=-1.87)
- `geopolitical_escalation_supply_shock` Geopolitical Escalation / Supply Shock · 지정학 확전·공급충격장: WATCH, score=46.13, confidence=64.68, coverage=1.00
  - supporting: USO 5d return (+0.0542, z=+0.54) | Geopolitical event overlay score (+0.0250, z=+1.00)
  - offsetting: PPA minus SPY 20d return (-0.1255, z=-1.67) | GLD 5d return (-0.1132, z=-1.51)
- `semiconductor_ai_cycle_shock` Semiconductor / AI Cycle Shock · AI·반도체 사이클 충격장: OFF, score=34.07, confidence=44.34, coverage=0.75
  - supporting: -
  - offsetting: SOXX 20d return (-0.0960, z=+0.77) | SOXX minus SPY 20d return (-0.0811, z=+0.81) | AI leaders basket 20d return (-0.0593, z=+0.79)
- `korea_domestic_financial_stress` Korea Domestic Financial Stress · 한국 내수 금융스트레스장: OFF, score=21.24, confidence=40.98, coverage=0.55
  - supporting: -
  - offsetting: Korea AA- 3Y credit spread (-0.1579, z=-1.58) | Korea CP-CD 91D spread (-0.0854, z=-1.71) | Korea household loan YoY growth (-0.0413, z=-1.65)
...
- 수치: score=75.17 | confidence=80.54(높음) | coverage=1.00(충분)
...
## 2. Stagflation / Reinflation / Energy Shock · 물가·에너지 재상승장
...
## 3. USD Strength / KRW Weakness · 달러강세/원화약세장
- 관점 lens: `fx_krw` (관련: `korea_market`)
- 상태 해석: `ACTIVE` (raw: `ACTIVE`) — 활성 구간입니다. 현재 시장을 설명하는 주요 상태로 볼 수 있습니다.
- 수치: score=63.21 | confidence=53.65(중간) | coverage=0.87(충분)
...
- 주요 지지 근거:
  - `USD/KRW level` — 지지 (contribution=+0.2043, normalized=+1.3621)
  - `FXI 20d return` — 지지 (contribution=+0.0576, normalized=-0.7681)
  - `UUP 20d return` — 지지 (contribution=+0.0509, normalized=+0.6791)
- 반대/완화 근거:
  - 상위 영향 지표 기준 뚜렷한 반대 신호는 제한적입니다.
- 주의점: 현재 정형 proxy 기준으로 큰 결측 caveat는 없습니다.
...
- anchor gap 보정 ticker: `KRW=X:2026-05-19<=2026-05-18`
- anchor date보다 최신 관측치가 별도로 있는 ticker: `KRW=X:2026-05-20`
