...
- `USD / KRW Pressure` — 리스크 팩터, ELEVATED (score=73.15, confidence=63.13, coverage=0.85)
...
- `higher_for_longer_long_rate_shock` Higher-for-Longer / Long-Rate Shock · 장기금리 부담장: STRESS, score=78.90, confidence=84.86, coverage=1.00
  - supporting: TLT 20d return (+0.3270, z=-1.87) | TLT minus SHY 20d return (+0.1347, z=-1.80) | HYG 20d return (+0.1242, z=-1.66)
  - offsetting: -
- `usd_strength_krw_weakness` USD Strength / KRW Weakness · 달러강세/원화약세장: ACTIVE, score=73.90, confidence=64.52, coverage=0.87
  - supporting: USD/KRW level (+0.2625, z=+1.75) | USD/KRW 20d return (+0.1530, z=+1.22) | FXI 20d return (+0.0576, z=-0.77)
  - offsetting: -
...
- `china_trade_fragmentation_shock` China / Trade Fragmentation Shock · 중국·무역분절 충격장: ACTIVE, score=59.60, confidence=55.92, coverage=0.83
  - supporting: FXI 20d return (+0.1152, z=-0.77) | USD/KRW 20d return (+0.0918, z=+1.22) | FXI minus SPY 20d return (+0.0810, z=-1.62)
  - offsetting: -
...
- `geopolitical_escalation_supply_shock` Geopolitical Escalation / Supply Shock · 지정학 확전·공급충격장: WATCH, score=49.24, confidence=68.29, coverage=1.00
  - supporting: USD/KRW 20d return (+0.0612, z=+1.22) | Geopolitical event overlay score (+0.0250, z=+1.00)
  - offsetting: PPA minus SPY 20d return (-0.1255, z=-1.67) | GLD 5d return (-0.1132, z=-1.51)
- `soft_landing_goldilocks` Soft Landing / Goldilocks · 우호적 위험선호장: WATCH, score=46.19, confidence=60.33, coverage=0.87
  - supporting: QQQ 20d return (+0.1325, z=+1.06)
  - offsetting: TLT 20d return (-0.1402, z=-1.87) | USD/KRW 20d return (-0.0918, z=+1.22)
- `semiconductor_ai_cycle_shock` Semiconductor / AI Cycle Shock · AI·반도체 사이클 충격장: OFF, score=38.22, confidence=47.94, coverage=0.75
  - supporting: USD/KRW 20d return (+0.0612, z=+1.22)
  - offsetting: SOXX 20d return (-0.0960, z=+0.77) | SOXX minus SPY 20d return (-0.0811, z=+0.81)
- `korea_domestic_financial_stress` Korea Domestic Financial Stress · 한국 내수 금융스트레스장: OFF, score=26.90, confidence=44.59, coverage=0.55
  - supporting: USD/KRW 20d return (+0.0612, z=+1.22)
...
- 수치: score=78.90 | confidence=84.86(높음) | coverage=1.00(충분)
...
- 수치: score=73.90 | confidence=64.52(중간) | coverage=0.87(충분)
...
- 주요 지지 근거:
  - `USD/KRW level` — 지지 (contribution=+0.2625, normalized=+1.7497)
  - `USD/KRW 20d return` — 지지 (contribution=+0.1530, normalized=+1.2237)
